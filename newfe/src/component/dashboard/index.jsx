  ...
  useEffect(() => {
    ...
    if (account.role === "ADMIN") {
      setItems([
        ...
        },
        {
          key: "/dashboard/size",
          icon: <UserOutlined />,
          label: <Link to={"/dashboard/size"}>Manage size</Link>,
        },
        {
          key: "/dashboard/price",
          icon: <UserOutlined />,
          label: <Link to={"/dashboard/price"}>View gold price</Link>,
        },
      ]);
    }
    ...
    if (account.role === "MANAGER") {
      setItems([
        ...
        {
          key: "/dashboard/shift-manager",
          icon: <UserOutlined />,
          label: <Link to={"/dashboard/shift-manager"}>Manage shift</Link>,
        },
        {
          key: "/dashboard/size",
          icon: <UserOutlined />,
        ...
        {
          key: "/dashboard/order-buy",
          icon: <UserOutlined />,
          label: <Link to={"/dashboard/order-buy"}>Manage order buy</Link>,
        },
        {
          key: "/dashboard/price",
          icon: <UserOutlined />,
      ...
      setItems([
        {
          key: "/dashboard/shift",
          icon: <UserOutlined />,
          label: <Link to={"/dashboard/shift"}>Manage shift</Link>,
        },
        {
          key: "/dashboard/price",
          icon: <UserOutlined />,
